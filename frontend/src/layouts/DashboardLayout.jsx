...
const MENU_CONFIG = {
  ...
  quan_tri_vien: [
    { to: '/quan-ly/thong-ke', icon: BarChart3, label: 'Dashboard Giám Đốc' },
    { to: '/quan-ly/tai-chinh', icon: Receipt, label: 'Báo cáo tài chính' },
    { to: '/quan-ly/du-bao-luong', icon: TrendingUp, label: '📈 Dự Báo Lưu Lượng AI' },
    { to: '/quan-ly/xep-lich', icon: Calendar, label: 'Xếp lịch làm việc' },
    { to: '/quan-ly/tra-cuu', icon: ClipboardList, label: 'Tra cứu hồ sơ' },
    { to: '/quan-ly/phe-duyet-don', icon: FileText, label: 'Phê duyệt đơn' },
    { to: '/quan-ly/nhan-vien', icon: Users, label: 'Nhân sự' },
